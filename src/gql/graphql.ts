...
export type GetNeedlineIssuesQuery = { issues: { nodes: Array<{ id: string, identifier: string, title: string, needs: { nodes: Array<{ priority: number, customer: { name: string } | null }> }, currentCustomerNeeds: { nodes: Array<{ id: string, priority: number, body: string | null }> } }> } };
