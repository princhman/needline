...
export type GetNeedlineIssuesQuery = { issues: { nodes: Array<{ id: string, title: string, needs: { nodes: Array<{ priority: number }> }, currentCustomerNeeds: { nodes: Array<{ id: string, priority: number, body: string | null }> }, status: { type: string } }> }, projects: { nodes: Array<{ id: string, title: string, needs: { nodes: Array<{ priority: number }> }, currentCustomerNeeds: { nodes: Array<{ id: string, priority: number, body: string | null }> }, status: { type: ProjectStatusType } }> } };
...
export type IssueCreateMutation = { issueCreate: { success: boolean, issue: { id: string, identifier: string, title: string, status: { type: string } } | null } };
